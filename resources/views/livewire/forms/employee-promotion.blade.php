...
{{--                    <label for="">Month/Year</label> <input wire:model.live="month" type="month" class="form-control-sm">--}}
{{--                    <label for="">Total no. of staff</label>--}}
{{--                    <input wire:model.lazy="number_of_staff" style="max-width: 120px" class="form-control-sm" readonly>--}}

                    <a href="{{url('assets/excel_sample/promotion.xlsx')}}" class="d-block text-danger">click to download sample excel file</a>
                </div>
            ...
            <div class="mx-3 float-right">
                <form action="" wire:submit.prevent="uploadFile()" class="inport_x">
                    ...
                    <label for="actual-btn" style="z-index: 999 !important;">@if($importFile) {{$importFile->getClientOriginalName()}} @else Choose File @endif</label>
            ...
            <table class="table table-bordered mt-2">
                ...
                @forelse($promotions as $promotion)
                    <tr>
                        ...
                        <td>
                            <button style="width: 55px !important;padding: 1px !important;" class="btn btn-danger float-right" wire:click="deleteId({{$promotion->id}})">Delete</button>
                            @if($promotion->status!=1)
                            <button style="width: 55px !important;padding: 1px !important;" class="btn edit_btn float-right" wire:click="edit_record({{$promotion->id}})">Edit</button>
                                @endif
                        </td>
                    </tr>
                @empty
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control @error('payroll_number') is-invalid @enderror" wire:model.lazy="payroll_number" type="text">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control @error('staff_number') is-invalid @enderror" wire:model.lazy="staff_number" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-12">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control @error('staff_name') is-invalid @enderror" wire:model.lazy="staff_name" disabled readonly type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                        ...
                        $salObj=\App\Models\SalaryStructureTemplate::where('salary_structure_id',$this->salary_structure)->select('grade_level')->get();
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <select  class="form-control @error('level') is-invalid @enderror" name="level" wire:model.blur="level" type="number" >
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group form-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><span class="d-none d-md-inline">Staff</span> Number</span></div>
                                    <input class="form-control @error('staff_number') is-invalid @enderror" wire:model.lazy="staff_number" readonly disabled type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-12">
