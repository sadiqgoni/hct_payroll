                            ...
                            <div class="col-12 col-md-6 col-lg4 offset-md-6 offset-lg-6">
                                <fieldset class="px-4">
                                    <legend>
                                        ...
                                        @if($edit==true)
                                            <h6> Update Pension Fund Administrator </h6>
                                        @endif
                                        @if($create==true)
                                            <h6> Add Pension Fund Administrator </h6>
                                        @endif
                                    </legend>
                                    <form class="">


                                        <input type="text" wire:model="name" class="form-control " placeholder="Pension Fund Administrator">
                                        @if($create==true)
