@if($create==true)
    <div>
        ...
        <fieldset>
{{--            <div wire:loading  wire:target="close store "style="position: absolute;z-index: 9999;text-align: center;width: 100%;height: 50vh;padding: 25vh">--}}
        ...
        @if ($steps == 1)
            <div class="p-4 border rounded">
                ...
                <div class="mt-2 flex justify-between">
                    <button  class="bg-gray-500 text-white px-4 py-2">Back</button>
                    <button wire:click="nextStep" class="bg-blue-500 text-white px-4 py-2">Next <span style="font-size: 10px;color: whitesmoke">Employment Data</span></button>
                </div>
            </div>
        @endif
        ...
        @if ($steps == 2)
            <div class="p-4 border rounded">
                            ...
                            @if($employment_type == 1 || $employment_type==3)
                                <div class="col-12 col-lg-auto">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input {{$disabled}} class="form-control  @error('contract_termination_date') is-invalid @enderror" wire:model.live="contract_termination_date" type="date">
                                        <div class="input-group-append"></div>
                                    </div>
                                </div>
                ...
                <div class="mt-2 flex justify-between">
                    ...
                    <button wire:click="nextStep" class="bg-blue-500 text-white px-4 py-2">Next <span style="font-size: 10px;color: whitesmoke">Salary & Pension Data</span></button>
                </div>
            </div>
        @endif
...
$salObjs=\App\Models\SalaryStructureTemplate::where('salary_structure_id',$this->salary_structure)->select('grade_level')->get();
                ...
                <div class="mt-2 flex justify-between">
                    <button wire:click="prevStep" class="bg-gray-500 text-white px-4 py-2">Back</button>
                    <button wire:click="nextStep" class="bg-blue-500 text-white px-4 py-2">Next <span style="font-size: 10px;color: whitesmoke">Next of Kin</span></button>
                </div>
            </div>
        @endif
        @if ($steps == 4)
            <div class="p-4 border rounded">
                ...
                <div class="mt-2 flex justify-between">
                    <button wire:click="prevStep" class="bg-gray-500 text-white px-4 py-2">Back</button>
                    <button wire:click="submit" class="btn-success text-white px-4 py-2">Submit</button>
                </div>
            </div>
        @endif
        {{--                </form>--}}
