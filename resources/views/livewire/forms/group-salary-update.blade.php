                        ...
                        <fieldset class="mt-3">
                            ...
                            <div class="row">
                                ...
                                @if($selected_allow_deduct==1 && $update_allow_deduct==2 )
                                        ...
                                        @if($paye_calculation == 4)
                                            <div class="col-12">
                                                <div class="alert alert-info">
                                                    <i class="fa fa-info-circle"></i> Using active tax bracket: <strong>{{ \App\Models\TaxBracket::active()->first()?->version_name ?? 'None configured' }}</strong>
                                                </div>
                                            </div>
                                        @endif
