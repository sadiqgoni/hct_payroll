            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <label for="">Search Employee</label> <input type="text" name="search" wire:model.live="search_employee"
                        wire:keydown.enter="searchEmployee" placeholder="Search with Payroll NO." class="form-control-sm"
                        ...
                        <fieldset>
                            ...
                            <legend class="py-0">
                                <div class="float-left">
                                    <button></button>
                                    @if($previous_id)
                                        <button class="btn btn-primary btn-sm" wire:click.prevent="view({{$previous_id}})">
                                            << Previous </button>
                                    @endif
                                            @if($next_id)
                                                <button class="btn btn-primary btn-sm" wire:click.prevent="view({{$next_id}})">Next
                                                    >></button>
                                            @endif
                                </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input class="form-control @error('salary_arears') is-invalid @enderror"
                                                    wire:model.live="salary_arears" type="text">
                                                <div class="input-group-append"></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 col-lg-6">
