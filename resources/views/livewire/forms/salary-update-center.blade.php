                  ...
                  <table class="table table-bordered table-stripped">
                      ...
                      @forelse($employees  as $employee)
                          <tr>
                              ...
                              <td><button class="btn btn-sm btn-info" wire:click.prevent="view({{$employee->id}})">View <i class="fa fa-eye"></i></button></td>
                          </tr>
                      @empty
    ...
    @if($record==false)
        ...
        <div class="row">
            <div class="col-12 text-center mb-2">
                <label for="">Search Employee</label>  <input type="text" name="search" wire:model.live="search_employee" wire:keydown.enter="searchEmployee" placeholder="Search with Payroll NO." class="form-control-sm" style="max-width: 300px !important;">
            </div>
            <div class="col-12">
                    ...
                    <fieldset>
                        ...
                        <legend class="py-0">
                            <div class="float-left">
                                ...
                                $next=$employee_info->id+1;
                                $previous=$employee_info->id-1
                                @endphp
                                <button></button>
                                @if($previous >= 1)
                                    <button class="btn btn-primary btn-sm"  wire:click.prevent="view({{$previous}})" > << Previous </button>
                                @endif
                                @if($next <= $user)
                                    <button class="btn btn-primary btn-sm" wire:click.prevent="view({{$next}})" >Next >></button>
                                @endif
                            </div>
...
{{--                            </div>--}}
                            <div class="float-right">
                                @if($employee_info->status==1)
                                    ...
                                    @can('can_save')
                                        <button class="btn reset_btn" type="button" wire:click.prevent="resetSalary()">Reset Salary <i class="fa fa-refresh"></i></button>
                                ...
                                <button class="btn close_btn " type="button" wire:click.prevent="close()">Close <i class="fa fa-times"></i></button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{$employee_info->full_name}}" type="text">
                            ...
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" {{$disabled}}  value="{{$employee_info->staff_number}}">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" {{$disabled}}  value="{{$employee_info->payroll_number}}">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" {{$disabled}} value="{{emp_status($employee_info->status)}}">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" {{$disabled}} value="{{emp_type($employee_info->employment_type)}}">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" {{$disabled}} value="{{dept($employee_info->department)}}">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{staff_cat($employee_info->staff_category)}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{ss($employee_info->salary_structure)}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-2">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{$employee_info->grade_level}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-2">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{$employee_info->account_number}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-2">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{$employee_info->bank_code}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" {{$disabled}} value="{{$employee_info->bank_name}}" type="text">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
...
{{--                    //salary info--}}
                    <div class="row  my-2">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Basic Salary</span></div>
                                            <input value="{{number_format($salary->basic_salary,2)}}" class="form-control @error('basic_salary') is-invalid @enderror" {{$disabled}} wire:model.blur="basic_salary" type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Salary Deduction</span></div>
                                            <input class="form-control @error('salary_deduction') is-invalid @enderror" wire:model.blur="salary_deduction"  type="text">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Salary Areas</span></div>
                                            <input class="form-control @error('salary_arears') is-invalid @enderror" wire:model.live="salary_arears" type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Total Deduction</span></div>
                                            <input class="form-control @error('total_deduction') is-invalid @enderror"
                                                   value="{{number_format($salary->total_deduction,2)}}" {{$disabled}} type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Total Allowance</span></div>
                                            <input class="form-control"   value="{{number_format($salary->total_allowance,2)}}" {{$disabled}} type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Gross Pay</span></div>
                                            <input class="form-control @error('gross_pay') is-invalid @enderror" value="{{number_format($salary->gross_pay,2)}}" {{$disabled}} type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Net Pay</span></div>
                                            <input class="form-control" value="{{number_format($salary->net_pay,2)}}" {{$disabled}} type="text">
                                            <div class="input-group-append"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-2 text-center" style="margin: auto">
                            ...
                            @endphp
                            {{round($total_sum)}}%
{{--                            <progress id="file" value="{{$total_sum }}" max="{{$gross}}"--}}
{{--                                      style="border:none;border-radius:25px;height: 50px;width: 100%;--}}
{{--                                      @if($total_sum <= 33)--}}
...
{{--                            </progress>--}}
                            <div class="progress bg-success" style="height: 50px">
                                <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{round($total_sum,2)}}" aria-valuemin="0" aria-valuemax="100" style="width: {{round($total_sum,2)}}%;height: 50px;">
                                    {{round($total_sum,2)}}%
                                </div>
                            </div>
                            @if($total_sum <= 33)
                                                ...
                                                @forelse ($allow as $allowance)
                                                    ...
                                                    <div class="col-12 col-md-4 col-lg-3">
                                                        <div class="input-group form-group">
                                                            ...
                                                            @enderror
                                                            <div class="input-group-prepend"><span class="input-group-text" style="font-size: 12px;border: none">
                                                                   {{ $allowance->allowance_name }}</span>
                                                            </div>
                                                            <input    type="text"
                                                                    wire:model.lazy="inputs.{{ $field }}"
                                                            ...
                                                            <div class="input-group-append" >
                                                                @if($allowance->allowance_type==1)
                                                                    <Button wire:click.prevent="resetSingle({{$allowance->id}})" style="font-size: 10px" class="border-0 btn">Reset</Button>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row py-4">
                                                ...
                                                @php $field = 'D' . $deduction->id; @endphp
                                                    <div class="col-12 col-md-4 col-lg-3 ">
                                                        ...
                                                        @enderror
                                                        <div class="input-group form-group">
                                                            <div class="input-group-prepend"><span class="input-group-text" style="font-size: 12px">{{$deduction->deduction_name}}</span></div>
                                                            <input @if($deduction->id ==5) {{$disabled}} @endif
                                                            type="text"
...
{{--                                                                --}}{{--                                                                <Button wire:click.prevent="resetDeductSingle({{$deduction->id}})" style="font-size: 10px" class="border-0 btn">Reset</Button>--}}
{{--                                                                --}}{{--                                                            @endif--}}
{{--                                                            </div>--}}
                                                        </div>
                                                    </div>
