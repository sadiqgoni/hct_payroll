<div>
    ...
    <div class="row">
        <div class="col-lg-12 p-3">
            <form action="{{route('retired.staff.report')}}" method="post" id="myForm" target="_blank">@csrf
                <fieldset>
                ...
                <div class="row mt-3">
                    <div class="col text-center">
                        ...
                        <button class="btn my-1 my-md-0  view" type="submit">View </button>
...
{{--    @include('form_spin')--}}
    ...
    @endsection
    @section('page_title')
       Payroll Report / Retirement List
    @endsection
</div>
