...
<head>
    ...
    <style>
        *{
        ...
        #footer { position: fixed; right: 0; bottom: 10px; text-align: center;border-top: 1px solid black;}
...
{{--        <div style="margin: 10px 0"></div>--}}
       ...
       <tr>
           ...
           <td>{{$paySlip->salary_structure}}  {{$paySlip->grade_level}}{{"/"}}{{$paySlip->step}} <br>Acc No.: {{$paySlip->account_number}}</td>
       </tr>
{{--       <tr>--}}
{{--           --}}
{{--       </tr>--}}
        ...
        <tbody>
            ...
            <tr>
                <td style="font-weight: bolder;padding-top: 20px !important;" colspan="4"><b>Gross Pay:{{number_format($paySlip->gross_pay,2)}}</b></td>
            </tr>
            <tr>
