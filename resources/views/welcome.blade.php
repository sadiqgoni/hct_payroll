...
<table class="table-bordered table-responsive" style="border-collapse: collapse;">
    <tr style="text-transform: uppercase; font-weight: bolder">
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 1</span></div>
                <input wire:model="step1"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 2</span></div>
                <input wire:model="step2"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 3</span></div>
                <input wire:model="step3"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 4</span></div>
                <input wire:model="step4"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 5</span></div>
                <input wire:model="step5"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 6</span></div>
                <input wire:model="step6"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 7</span></div>
                <input wire:model="step7"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 8</span></div>
                <input wire:model="step8"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 9</span></div>
                <input wire:model="step9"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 10</span></div>
                <input wire:model="step10"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 11</span></div>
                <input wire:model="step11"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 12</span></div>
                <input wire:model="step12"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 13</span></div>
                <input wire:model="step13"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 14</span></div>
                <input wire:model="step14"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
        <td>
            <div class="input-group form-group">
                <div class="input-group-prepend"><span class="input-group-text">Step 15</span></div>
                <input wire:model="step15"   class="form-control" type="text">
                <div class="input-group-append"></div>
            </div>
        </td>
    ...
    <tr>
        <td colspan="3"><button class="btn btn-block btn-success">Update</button></td>
        <td colspan="2"><button class="btn btn-block btn-danger">Cancel</button></td>
    </tr>
    <tfoot>
...
<div wire:ignore.self class="tab-pane" id="profile-v" role="tabpanel">
    <div class="row py-4">
        @forelse(\App\Models\Deduction::where('status',1)->limit('12')->get() as $key=>$deduction)
            @php
                $d=$salary['D'.$deduction->id];
            @endphp
            <div class="col-12 col-md-4 col-lg-3 ">
                ...
                <div class="input-group form-group">
                    ...
                    <input name="deduction_inputs[{{$key}}][scores]" class="form-control @error('deduction') is-invalid @enderror" value="{{number_format($d,2)}}"  @if($deduction->deduction_type==1) {{$disabled}} @else wire:model.defer="deduction_inputs.{{$deduction->id}}" id="score{{$key}}" @endif type="text">
...
<div wire:ignore.self class="tab-pane" id="messages-v" role="tabpanel">
    <div class="row py-4">
        @forelse(\App\Models\Deduction::where('status',1)->where('id','>',12)->limit('12')->get() as $key=>$deduction)
            @php
                $d=$salary['D'.$deduction->id];
            @endphp
            <div class="col-12 col-md-4 col-lg-3 ">
...
<div wire:ignore.self class="tab-pane" id="settings-v" role="tabpanel">
    <div class="row py-4">
        @forelse(\App\Models\Deduction::where('status',1)->where('id','>',24)->get() as $key=>$deduction)
            @php
                $d=$salary['D'.$deduction->id];
            @endphp
            <div class="col-12 col-md-4 col-lg-3 ">
...
function formular_one($employee_id)
{
    $employee=\App\Models\EmployeeProfile::find($employee_id);
    $salary_update=\App\Models\SalaryUpdate::where('employee_id',$employee_id)->first();
//    $salary_template=SalaryStructureTemplate::where('salary_structure_id',$employee->salary_structure)
...
//        dd($salary_update);
    ...
    $annual_basic=$salary_update->basic_salary;
...
function formular_two($employee_id)
{
    $employee=\App\Models\EmployeeProfile::find($employee_id);
    $salary_update=\App\Models\SalaryUpdate::where('employee_id',$employee_id)->first();
    ...
    $allowances=\App\Models\Allowance::where('taxable',1)
        ->get();
    $annual_basic=$salary_update->basic_salary;
    $total_allow=$allowances->sum('value');
    $basic_salary=round($annual_basic/12,2);
